...
\jobentry
	...
	{ % Description
		...
		\item Developed strong understanding of the low-end microcontroller market (≤256KB of flash) % finding competitor weaknesses, internal strengths, and produced actionable marketing strategies from the research
		...
		\begin{itemize}[topsep=-10pt, leftmargin=10pt, label=\(\circ\)]
			...
			% \item My presentations became the preferred technical resource for sales when presenting to customers
			\end{itemize}
...
{ % Description
	...
	\end{itemize}
	% \item Designed and proposed viable solutions after performing a feasibility study
...
\section{Education}
	...
	\small\textsc{3.98 GPA; Summa Cum Laude; CMPE 322/120 Supplemental Instructor}\\ % Honors, achievements or distinctions (e.g. first class honors)
