...
\jobentry
	...
	{8-bit MCU Technical Marketing Engineer} % Job title
	{ % Description
		...
		\end{itemize}
		% \item Developed prototype products on PIC and AVR microcontrollers (see DMX Light Show, The Cold Plate). This included writing and documenting code and test conditions as well as completing design documents and flowcharts.
		% \item Created and documented example libraries for abstracted use in collaboration with a local/global team.

		% \item Performed engineering analysis to identify project purposes, key deliverables and implementation as well as strategized prototype launch.
...
\jobentry
	...
	{Systems R\&D Engineer} % Job title
	{ % Description
...
\jobentry
	...
	{FT/PT} % FT/PT (full time or part time)
	{US Naval Research Lab - Space Technology Division} % Employer
...
% % DMX Light Show
% \vspace*{20pt} % title's anchor box
...
\begin{supertabular}{l l} % Start a table with two columns, the table will ensure everything is aligned
	...
	\small\textsc{Summa Cum Laude; 3.98 GPA; CMPE 322/120 SI}\\ % Honors, achievements or distinctions (e.g. first class honors)
