...
%---------------------------------------------------------------------------------------
% https://jobs.apple.com/en-us/details/200409038/hid-firmware-quality-engineer
%
...
\jobentry
	...
	{Prototype Consultant} % Job title
	{ % Description
...
\jobentry
	...
	{ % Description
		...
		\item Recovered RF communications lost to noise by augmenting message-passing algorithms with machine learning and data processing techniques using numpy and pandas.
...
This project demonstrates clean code practices and documentation as well as working within a team.\\
...
PCB were made to handle the high voltage PoE, digital signals, and analog inputs. Also C drivers were needed for the UART, DMA, DMX and SPI.
