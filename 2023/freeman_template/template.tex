...
A real-time audio processing light show integrating audio filtering, DMX, DMA, PoE, and a hardware-encoded WS2812 driver.\\ 
...
Custom python and bash programs handled data extraction and movement into and out of the neural network.
...
It is Microchip's most copied code repository.% The Cold Plate
