...
\columnratio{0.243,0.27,0.243,0.243}
\setlength{\columnsep}{5pt}

\begin{paracol}{4} % Begin four-column mode

% DMX Light Show
\project
	{DMX Light Show} % Name
	{https://github.com/jfcbooth/dmx} % Link
	{printer} % File
	{ % Description
		
		\raggedright A real-time audio processing light show integrating audio filtering, DMX, PoE, and a hardware-encoded WS2812 driver.
	}
...
\project
	{AI-Driven Security System} % Name
	{https://github.com/jfcbooth/security_system} % Link
	{security_system} % File
	{ % Description
...
% 3D PEEK Printer
\project
	{3D PEEK Printer} % Name
	{https://github.com/jfcbooth/3dpp} % Link
	{printer} % File
	{ % Description
...
\project
	{The Cold Plate} % Name
	{https://github.com/microchip-pic-avr-examples/pic16f17146-cold-plate-mplab-mcc} % Link
	{cold_plate} % File
	{ % Description
...
\begin{supertabular}{r l} % Start a table with two columns, the table will ensure everything is aligned
	...
	\qualificationentry
		{2018-2022} % Duration 
		{Computer Engineering; Mathemtics minor} % Degree
