...
\jobentry
	...
	{ % Description
		...
		as well as for expansion, such as building an human-sized PEEK 3D printer for biofuel refinement.
...
\begin{itemize}
	\itemsep 0pt
	\item \textbf{Technical:} C, Python, Linux, Embedded Development, Digital Circuit Design, 3D CAD Design, Data Analytics, Marlin
